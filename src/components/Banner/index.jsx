  ...
  return (
    <div className="bg-primary-100">
      <div className="container mx-auto max-w-[1344px]">
        <div className="px-5 py-9 flex flex-col gap-8 sm:gap-10 md:gap-16 md:pb-0 lg:gap-20 lg:px-10 lg pt-12 overflow-hidden">
          <motion.section
            initial="hidden"
            whileInView="visible"
          ...
          >
            <SubHead style="sm:w-4/5 md:w-9/12 lg:w-9/12" color="text-white">
          ...
          <div className="w-full flex justify-center">
            <motion.img
              ...
              className="w-[375px] sm:w-[550px] md:w-[723px] lg:w-full h-auto object-cover mb-14"
